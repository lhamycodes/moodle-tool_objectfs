...
function clearLock()
{
    ...
    $releaseAdhoc = $DB->delete_records("mdl_lock_db", array("resourcekey" => '%adhoc%task%%'));
    $releaseScheduleRunner = $DB->delete_records("mdl_lock_db", array("resourcekey" => '%schedule%runner%'));
